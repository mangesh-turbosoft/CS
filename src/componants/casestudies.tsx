  ...
  return (
    <section className="w-full panel desktop:min-h-screen flex flex-col xl:flex-row">
      <div className="reveal-up md:hidden bg-white px-5 sm:px-6 py-16">
        <span
          className="block font-bold text-[#f04c3e] leading-tight"
          style={{
            fontSize:
              "clamp(22px, calc(22px + (32 - 22) * ((100vw - 320px) / (1600 - 320))), 32px)",
          }}
        >
          White-label Development
        </span>
        <p
          className="text-[#7b7b7b] leading-relaxed mt-[4px]"
          style={{
            lineHeight: "1.2",
            fontSize:
              "clamp(20px, calc(20px + (26 - 20) * ((100vw - 320px) / (1600 - 320))), 26px)",
          }}
        >
          Design agencies often face challenges scaling development capacity
          while maintaining quality and timelines. Our white-label web
          development service enables your team to stay focused on strategy,
          design, and client relationships while our experienced developers
          deliver reliable, high-quality builds behind the scenes.
        </p>
      </div>
      ...
      <div className="w-full xl:w-1/2 relative bg-black flex flex-col">
        <div className="relative flex-1 overflow-hidden">
          <video ref={videoRef} className="w-full h-full object-cover">
            <source src="/video/Rob-iflourish4.m4v" type="video/mp4" />
          </video>
        ...
        <div className="px-5 sm:px-6 md:px-8 py-5 md:py-6 bg-white">
          <p className="font-bold text-gray-500 text-[24px] sm:text-[28px] lg:text-[32px] leading-tight mb-2">
      ...
      <div className="w-full xl:w-1/2 flex flex-col">
        <div className="flex flex-col md:flex-row flex-1">
          ...
          >
            ...
            >
              <h2 className="figtree text-white text-center font-bold text-[clamp(34px,calc(34px+(48-34)*((100vw-1281px)/(1600-1281))),48px)] leading-tight">
                The Process
              </h2>
            </Link>
          </div>
