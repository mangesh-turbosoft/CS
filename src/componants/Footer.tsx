...
export default function Footer() {
  return (
    <footer className="w-full bg-[#373737] text-[#aaa] text-[16px] md:text-[18px] lg:text-[20px] py-[21px]">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 md:px-8 lg:px-[50px] flex flex-col desktop:flex-row items-center justify-between gap-0 desktop:gap-2 text-center desktop:text-left">
